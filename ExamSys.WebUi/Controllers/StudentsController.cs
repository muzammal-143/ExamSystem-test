...
namespace ExamSys.WebUi.Controllers
{
    public class StudentsController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id,Roll_No,First_Name,Last_Name,Password,Session,Gender,Picture,Email,RegistrationNO,Semester,Department,Status,Designation,created_at,edited_at")] Students students)
        {
            if (ModelState.IsValid)
            {
